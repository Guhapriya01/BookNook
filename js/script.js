...
function addItemDOM() {
  ...
  if (!items || items.length === 0) {
    document.getElementById("cart").innerHTML = "<p style=\"margin-top: 0;margin-bottom: 1rem;font-size: 29px;padding: 55px;font-variant: petite-caps\">Cart is Empty !! </p>";
  }
    ...
    items.forEach(book => {
      ...
      <td style= "padding-right:50px; padding-bottom: 80px; text-align: center;"><img src="${thumbnail}" alt="${title}" />
        <br>
        <button style="background-color: red; height: 44px; border-radius: 28px; width: 162px; margin:15px"
