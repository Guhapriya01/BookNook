...
let currentBooks = []; // Current page of books
const totalPages = 6;
var butt1 = false;
var butt2 = false;
var butt3 = false;
...
function displayTable(page) {
  ...
  for (let i = startIndex; i < endIndex && i < currentBooks.length; i++) {
    ...
    row.innerHTML =`
      <div>
      <td style= "padding-right:50px; padding-bottom: 80px; text-align: center;"><img src="${thumbnail}" alt="${title}" />
        <br>
      </td>
        <td style= "padding-bottom: 80px; width:400px"><strong style="
        font-style: oblique;
        font-variant: all-small-caps;
        font-size:larger; ">${title}</strong><br><br>
        <strong> Authors :  ${authors}</strong>
        <br>
        <p>Published Date :  ${date}</p>
        <h6>Price : &#8377 ${price}</h6>
        <br>
  ...
  function generatePagination() {
    ...
    for (let i = 1; i <= totalPages; i++) {
      ...
      button.setAttribute('id','buttonR');
      button.innerText = i;
...
function displayResults(books) {
    ...
    books.slice(0,resultsPerPage).forEach(book => {
      ...
      const thumbnail = book.volumeInfo.imageLinks ? book.volumeInfo.imageLinks.thumbnail : "data:image/png;base64,";
